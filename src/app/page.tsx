                            ...
                            <div className="p-4 rounded mt-3 mt-md-5">
                                ...
                                <Row>
                                    ...
                                    <Col className="text-start" md={9} xs={11}>
                                        ...
                                        <p>Quando o cliente chega até seu WhatsApp querendo fazer um pedido o link do seu cardápio digital é enviado. O robô também pode ajudar a solucionar problemas, mas prontamente acionará um humano por meio de
                                            aviso no seu dashboard se necessário.</p>
                                    </Col>
                                </Row>
                            </div>
                        </Col>
                            ...
                            <div className="p-4 rounded mt-3 mt-md-5">
                                ...
                                <Row>
                                    ...
                                    <Col className="text-start" md={9} xs={11}>
                                        ...
                                        <p>O pedido realizado é enviado para sua tela de gestão totalmente intuitiva e o sistema notifica o cliente pelo WhatsApp sobre o andamento do pedido. <br/><i>(Ex: pedido em preparaçao, saiu pra entrega,
                                            etc)</i></p>
                                    </Col>
                                </Row>
                            </div>
                            ...
                            <div className="mt-md-5 pt-md-5 pt-3">
                                <Col xs={12} md={10}>
                                    ...
                                    <div className="pt-md-5">
                                        ...
                                        <p>Somos especialistas em tornar a vida mais fácil para os negócios! Com a PedeMais.Ai facilitamos o atendimento ao cliente e agilizamos suas operações, sem complicações. E não importa se você tem uma
                                            hamburgueria, uma pizzaria ou uma sorveteria, nós estamos aqui para te ajudar a crescer!</p>
                                    </div>
                                </Col>
