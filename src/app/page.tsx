...
<Navbar bg="light" expand="md" fixed="top" className="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 border-bottom shadow-sm" style={{ maxHeight: '81px' }}>
    ...
    <Form className="p-4" style={{ borderRadius: '8px', boxShadow: '10px 10px 10px rgba(0, 0, 0, 0.1)', marginBottom: '20px', marginRight: '20px', border: '1px solid #ccc' }}>
        ...
        <Row className="card-deck mb-3 text-center">
            ...
            <Card className="mb-4 shadow-sm">
                ...
                <Card.Body>
                    ...
                    </ul> <Button variant="outline-primary" size="lg">Sign up for free</Button>
                </Card.Body>
            </Card>
            </Col>
            <Col md={4}>
            <Card className="mb-4 shadow-sm">
                ...
                <Card.Body>
                    ...
                    <ul className="list-unstyled mt-3 mb-4">
                        ...
                        <li>Help center access</li>
                    </ul> <Button variant="primary" size="lg">Get started</Button>
                </Card.Body>
            </Card>
            </Col>
            <Col md={4}>
            <Card className="mb-4 shadow-sm">
                ...
                <Card.Body>
                    ...
                    <ul className="list-unstyled mt-3 mb-4">
                        ...
                        <li>Help center access</li>
                    </ul> <Button variant="primary" size="lg">Contact us</Button>
                </Card.Body>
            </Card>
            </Col>
        </Row>
        <footer className="pt-4 my-md-5 pt-md-5 border-top">
            <Row>
                <Col xs={12} md={3}> <img className="mb-2" src="/docs/4.4/assets/brand/bootstrap-solid.svg" alt="" width="24" height="24" /> <small className="d-block mb-3">Copyright&copy; 2019-2024, pede.AI. Todos os direitos reservados.</small> </Col>
                <Col xs={6} md={3}>
                <h5>Features</h5>
